...
object DefaultGraphqlSchemaProviderTest extends MockitoSugar {
  ...
  val COMPUTED_TYPES = Set(
    ...
    "org_coursera_naptime_ari_graphql_models_platformSpecificData",
    "org_coursera_naptime_ari_graphql_models_NewPlatformDataMember",
    "org_coursera_naptime_ari_graphql_models_NewPlatformData",
    "org_coursera_naptime_ari_graphql_models_OldPlatformDataMember",
    "PartnersV1",
    "ResponsePagination",
    "stringMember",
    "DataMap")
